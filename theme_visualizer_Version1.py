...
class ThemePreview:
    ...
    def create_image_preview(theme: Dict[str, Any], output_path: str, size: Tuple[int, int] = (800, 600)) -> bool:
        ...
        try:
            ...
            term_content = [
                f"user@triad > echo 'Hello, world!'",
                f"Hello, world!",
                f"",
                f"user@triad > ls -la",
                f"total 32",
                f"drwxr-xr-x  5 user  staff   160 Aug 22 12:34 .",
                f"drwxr-xr-x  3 user  staff    96 Aug 22 12:30 ..",
                f"-rw-r--r--  1 user  staff  1823 Aug 22 12:32 README.md",
                f"drwxr-xr-x  8 user  staff   256 Aug 22 12:33 src",
                f"",
                f"user@triad > _"
            ]
    ...
    def load_themes(self) -> Dict[str, Dict[str, Any]]:
        ...
        for filename in os.listdir(self.theme_dir):
            if filename.endswith(".json"):
                try:
                    with open(os.path.join(self.theme_dir, filename), "r") as f:

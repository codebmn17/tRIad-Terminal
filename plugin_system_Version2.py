...
class PluginLoader:
    ...
    @staticmethod
    def load_from_path(plugin_dir: str) -> type[PluginInterface] | None:
...
class PluginManager:
    ...
    def load_plugin(self, plugin_name: str) -> PluginInterface | None:
    ...
    def disable_plugin(self, plugin_name: str) -> bool:
        ...
        for name, p in self.plugins.items():
            if (
                name in self.enabled_plugins
                and p.metadata.dependencies
                and plugin_name in p.metadata.dependencies
            ):

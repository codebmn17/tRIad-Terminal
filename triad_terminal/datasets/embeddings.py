...
class EmbeddingsManager:
    ...
    def search_dataset(self, dataset_id: str, query: str, limit: int = 10, threshold: float = 0.7) -> List[SearchResult]:
    ...
    def search_multiple_datasets(self, dataset_ids: List[str], query: str, limit: int = 10, threshold: float = 0.7) -> List[SearchResult]:
        """Search across multiple datasets."""
        all_results = []
        
        for dataset_id in dataset_ids:
            results = self.search_dataset(dataset_id, query, limit * 2, threshold)  # Get more results per dataset
    ...
    def search_all_ready_datasets(self, query: str, limit: int = 10, threshold: float = 0.7) -> List[SearchResult]:

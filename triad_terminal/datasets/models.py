...
class DatasetRecord(BaseModel):
    ...
    error_message: Optional[str] = Field(None, description="Latest error message if any")
    progress: Optional[Dict[str, Any]] = Field(None, description="Phase-specific progress info")
...
class DatasetRegistry(BaseModel):
    ...
    def filter_datasets(self, category: Optional[str] = None, ready: Optional[bool] = None) -> List[DatasetRecord]:
...
class SearchRequest(BaseModel):
    ...
    dataset_ids: Optional[List[str]] = Field(None, description="Datasets to search in")

...
class IngestionPhase:
    ...
    def should_run(self, dataset: DatasetRecord, force: bool = False, skip_phases: Optional[List[str]] = None) -> bool:
...
class IngestionPipeline:
    ...
    def ingest_dataset(self, dataset_id: str, force: bool = False, skip_phases: Optional[List[str]] = None) -> bool:
    ...
    def ingest_datasets_batch(self, dataset_ids: List[str], force: bool = False, skip_phases: Optional[List[str]] = None) -> int:
    ...
    def _ingest_dataset_thread(self, dataset: DatasetRecord, force: bool = False, skip_phases: Optional[List[str]] = None):

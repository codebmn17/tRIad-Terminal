...
from .models import DatasetRegistry, DatasetRecord
...
class DatasetRegistryManager:
    ...
    def list_datasets(self, category: Optional[str] = None, ready: Optional[bool] = None) -> List[DatasetRecord]:
...
_registry_manager: Optional[DatasetRegistryManager] = None

...
class DeploymentTemplates:
    ...
    @staticmethod
    def create_vercel_template(name: str, production: bool = False, team: str | None = None) -> DeploymentTarget:
    ...
    @staticmethod
    def create_netlify_template(name: str, site_id: str | None = None,

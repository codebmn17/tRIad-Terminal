...
class VoiceInterface:
    ...
    def speak(self, text: str, blocking: bool = False, 
             with_avatar: bool = True, animation: bool = True) -> None:
    ...
    def change_voice(self, gender: str = None, rate: float = None, 
...
class CommandLineVoiceInterface:
    ...
    def _run_test(self) -> None:
        ...
        self.voice_interface.speak("This is the default voice of the Triad Terminal system.", blocking=True)
        ...
        print("Fast voice:")
        self.voice_interface.change_voice(rate=1.5)
        self.voice_interface.speak("This is a faster speaking rate for when you need information quickly.", blocking=True)
        
        print("Slow voice:")
        self.voice_interface.change_voice(rate=0.8)
        self.voice_interface.speak("This is a slower speaking rate for clearer communication.", blocking=True)
    ...
    def _show_settings(self) -> None:
        ...
        for engine_name, engine_data in self.voice_interface.voice.tts_engines.items():
            print(f"  - {engine_name} ({engine_data.get('type', 'unknown')}, {engine_data.get('quality', 'unknown')} quality)")

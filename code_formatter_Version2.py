...
class CodeFormatter:
    ...
    def format_python(file_path: str, style: str = "pep8") -> tuple[bool, str]:
        ...
        try:
            ...
            try:
                subprocess.run(
                    [sys.executable, "-m", "black", "--version"], capture_output=True, check=True
                )
            ...
            result = subprocess.run(
                [sys.executable, "-m", "black", file_path], capture_output=True, text=True
            )
    ...
    def format_javascript(file_path: str, style: str = "standard") -> tuple[bool, str]:
        ...
        try:
            ...
            result = subprocess.run(
                ["npx", "prettier", "--write", file_path], capture_output=True, text=True
            )

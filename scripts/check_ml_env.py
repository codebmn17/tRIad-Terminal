...
def check_api_availability() -> Dict[str, Any]:
    ...
    try:
        ...
        ml_response = client.post("/ml/predict", json={
...
def check_backward_compatibility() -> Dict[str, Any]:
    ...
    try:
        ...
        try:
            ...
            return {
                "working": False,
                "error": "Expected ImportError was not raised"
            }
        except ImportError as e:
            # This is expected
            error_msg = str(e)
...
def main():
    ...
    if predictor_status["available"]:
        print_status("Models loaded", len(predictor_status["models"]) > 0, 
    ...
    ml_ready = predictor_status["available"] and core_available >= 4  # At least sklearn, numpy, fastapi, uvicorn

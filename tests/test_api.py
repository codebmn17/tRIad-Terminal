...
class TestMLEndpoints:
    ...
    def test_ml_predict_with_model_type(self):
        ...
        response = client.post("/ml/predict", json={"features": test_features, "model_type": "knn"})
    ...
    def test_ml_predict_invalid_features_non_numeric(self):
        ...
        response = client.post("/ml/predict", json={"features": ["a", "b", "c", "d"]})
    ...
    def test_ml_predict_wrong_feature_count(self):
        ...
        response = client.post(
            "/ml/predict", json={"features": [1.0, 2.0]}  # Only 2 features instead of 4
        )

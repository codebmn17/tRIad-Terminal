...
class ApplicationMonitor:
    ...
    def get_application_metrics(self, name: str | None = None) -> dict[str, Any] | dict[str, dict[str, Any]]:
    ...
    def get_application_history(self, name: str | None = None) -> list[dict[str, Any]] | dict[str, list[dict[str, Any]]]:

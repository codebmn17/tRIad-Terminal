    ...
    def _initialize_engines(self) -> None:
        ...
        try:
            ...
            for voice in voices:
                ...
                if voice_type != "default" and voice_type.lower() in voice_name or gender == "male" and ("male" in voice_name or "david" in voice_name or "george" in voice_name) or gender == "female" and ("female" in voice_name or "zira" in voice_name or "heera" in voice_name):
